...
RSpec.describe 'merchant invoice show page' do
  ...
  before(:each) do
    ...
    @invoice_item_2 = InvoiceItem.create(quantity: 2, unit_price: 100, invoice_id: @invoice_1.id, item_id: @shoe_1.id, status: 1)
    @invoice_item_3 = InvoiceItem.create(quantity: 2, unit_price: 100, invoice_id: @invoice_1.id, item_id: @shoe_1.id, status: 1)
